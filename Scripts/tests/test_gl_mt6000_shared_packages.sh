...
grep -n '^CONFIG_PACKAGE_luci-app-openclash=' "$FW3_OUT" | tail -n 1 | grep -q 'CONFIG_PACKAGE_luci-app-openclash=y'
grep -n '^CONFIG_PACKAGE_luci-app-openclash=' "$FW4_OUT" | tail -n 1 | grep -q 'CONFIG_PACKAGE_luci-app-openclash=m'
grep -n '^CONFIG_PACKAGE_luci-app-wrtbwmon=' "$FW3_OUT" | tail -n 1 | grep -q 'CONFIG_PACKAGE_luci-app-wrtbwmon=y'
grep -n '^CONFIG_PACKAGE_luci-i18n-wrtbwmon-zh-cn=' "$FW3_OUT" | tail -n 1 | grep -q 'CONFIG_PACKAGE_luci-i18n-wrtbwmon-zh-cn=y'
grep -n '^CONFIG_PACKAGE_wrtbwmon=' "$FW3_OUT" | tail -n 1 | grep -q 'CONFIG_PACKAGE_wrtbwmon=y'
grep -n '^CONFIG_PACKAGE_luci-app-dockerman=' "$FW3_OUT" | tail -n 1 | grep -q 'CONFIG_PACKAGE_luci-app-dockerman=m'
grep -n '^CONFIG_PACKAGE_luci-app-mosdns=' "$FW3_OUT" | tail -n 1 | grep -q 'CONFIG_PACKAGE_luci-app-mosdns=m'
grep -n '^CONFIG_PACKAGE_luci-app-bandix=' "$FW3_OUT" | tail -n 1 | grep -q 'CONFIG_PACKAGE_luci-app-bandix=m'
grep -n '^CONFIG_PACKAGE_bandix=' "$FW3_OUT" | tail -n 1 | grep -q 'CONFIG_PACKAGE_bandix=m'
grep -n '^CONFIG_PACKAGE_luci-app-nlbwmon=' "$FW3_OUT" | tail -n 1 | grep -q 'CONFIG_PACKAGE_luci-app-nlbwmon=m'
grep -n '^CONFIG_PACKAGE_luci-i18n-nlbwmon-zh-cn=' "$FW3_OUT" | tail -n 1 | grep -q 'CONFIG_PACKAGE_luci-i18n-nlbwmon-zh-cn=m'
grep -n '^CONFIG_PACKAGE_luci-app-openvpn=' "$FW3_OUT" | tail -n 1 | grep -q 'CONFIG_PACKAGE_luci-app-openvpn=m'
grep -n '^CONFIG_PACKAGE_luci-i18n-openvpn-zh-cn=' "$FW3_OUT" | tail -n 1 | grep -q 'CONFIG_PACKAGE_luci-i18n-openvpn-zh-cn=m'
grep -n '^CONFIG_PACKAGE_luci-app-openvpn-server=' "$FW3_OUT" | tail -n 1 | grep -q 'CONFIG_PACKAGE_luci-app-openvpn-server=m'
grep -n '^CONFIG_PACKAGE_luci-i18n-openvpn-server-zh-cn=' "$FW3_OUT" | tail -n 1 | grep -q 'CONFIG_PACKAGE_luci-i18n-openvpn-server-zh-cn=m'
grep -n '^CONFIG_PACKAGE_hd-idle=' "$FW3_OUT" | tail -n 1 | grep -q 'CONFIG_PACKAGE_hd-idle=m'
